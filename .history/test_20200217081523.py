...
def one_vs_one(source, target):
    ...
    output_path = os.path.join(conversions_dir, f'{source_file_name}_to_t{target}.wav')
...
if __name__ == '__main__':
    ...
    parser.add_argument('-hps', help='The path of hyper-parameter set', default='hps/vctk.json')
    parser.add_argument('-model', '-m', help='The path of model checkpoint', default='model.pkl')
