...
if __name__ == '__main__':
    ...
    parser.add_argument('-dataset_path', default='/home/julian/Documentos/PI_JCL/Experimentos/Experimento 5/data.h5')
    parser.add_argument('-index_path', default='/home/julian/Documentos/PI_JCL/Experimentos/Experimento 5/index.json')
