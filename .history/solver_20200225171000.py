...
class Solver(object):
    ...
    def load_good_classifier(path='/home/julian/Documentos/multitarget-voice-conversion-vctk_CHOU_CONVERT/good_classifier.pkl'):
        if good_clf:
    ...
    def probar_clf_bueno(self, source):
        ...
        logits = test_good_clf(spec_tensor, c)
